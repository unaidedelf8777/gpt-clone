...
const ProfileModal: React.FC<ProfileModalProps> = ({ logout }) => {
    ...
    return (
        <button
            onClick={logout}
            className="flex px-3 min-h-[44px] py-1 items-center gap-3 dark:text-white cursor-pointer text-sm hover:bg-gray-100 dark:hover:bg-gray-800 mt-3 rounded-lg"
